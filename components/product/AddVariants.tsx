...
export default function AddVariants({
  ...
  useEffect(() => {
    ...
    const sortedAttributes =
      attributes?.productAttributes?.sort(
        (a: any, b: any) => a.attributeValues.length - b.attributeValues.length,
      ) || [];
          ...
          >
            <div>
              <div className="flex flex-wrap gap-3">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputNumber
                        value={field.value}
                        onValueChange={e =>
                          setValue(`varients.${index}.price`, e.value)
                        }
                        placeholder="Price"
                      />
                    )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputNumber
                        value={field.value}
                        onValueChange={e =>
                          setValue(`varients.${index}.specialPrice`, e.value)
                        }
                ...
                {addtionalInfo?.stockType === 'variable' ? (
                  <div className="flex-auto">
                    <Controller
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <InputNumber
                          ...
                          onValueChange={e =>
                            setValue(`varients.${index}.totalStock`, e.value)
                          }
                        />
                      )}
                    />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputNumber
                        value={field.value}
                        onValueChange={e =>
                          setValue(`varients.${index}.weight`, e.value)
                        }
                        placeholder="Weight"
                      />
                    )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputNumber
                        value={field.value}
                        onValueChange={e =>
                          setValue(`varients.${index}.height`, e.value)
                        }
                        placeholder="Height"
                      />
                    )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputNumber
                        value={field.value}
                        onValueChange={e =>
                          setValue(`varients.${index}.breadth`, e.value)
                        }
                        placeholder="Breadth"
                      />
                    )}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputNumber
                        value={field.value}
                        onValueChange={e =>
                          setValue(`varients.${index}.length`, e.value)
                        }
                        placeholder="Length"
                      />
                    )}
