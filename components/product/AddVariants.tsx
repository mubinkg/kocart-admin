...
export default function AddVariants({ attributes, addtionalInfo, createProductVariantInput, setCreateProductVariantInput }: {
    attributes: any, addtionalInfo: any, createProductVariantInput: any,
                        ...
                        <AccordionTab key={item.id} header={() => (<div className='flex justify-content-between'>
                            ...
                            <div>
                                <div className='flex flex-wrap gap-3'>
                                    ...
                                    {
                                        addtionalInfo?.stockType === 'variable' ? (<div className='flex-auto'>
                                            <Controller
