...
export default function RegisterSeller() {
  ...
  const [registerSeller, { data, error, loading }] =
    useMutation<any>(REGISTER_SELLER);
  ...
  const onSubmit: SubmitHandler<RegisterSeller> = async (
    data: RegisterSeller,
  ) => {
    try {
  ...
  return (
    <div className="align-items-center justify-content-center flex h-screen">
      <Card className="no-scrollbar h-full" style={{ overflowY: 'scroll' }}>
        <div className="flex-column flex items-center overflow-auto">
          ...
          <div>
            <form className="flex-column flex gap-4">
              <div>
                ...
                <div className="mt-3 flex items-center gap-5">
                  <label className="w-10rem inline-block">
                    Confirm Password
                  </label>
                  <InputText
                    className="w-full"
                ...
                <div className="mt-3 flex items-center gap-5">
                  ...
                  <InputText
                    className="w-full"
                    {...register('address')}
                    placeholder="House 13/A Banani DOHS"
                  />
                </div>
                <div className="mt-3 flex items-center gap-5">
