...
export default function Page() {
    const { setValue, control, formState:{errors}, handleSubmit, reset} = useForm<any>({
    ...
    return (
        <Card className="m-4">
            ...
            >
                ...
                <Column field="minimum_free_delivery_order_amount" header="Minumim Free Delivery Order Amount" />
            </DataTable>

            <Dialog header="Create New Area" visible={visible} onHide={() => setVisible(false)} className="w-6">
                <div className="flex flex-column">
                    <p className="mb-2 font-semibold">Area Name <span className="text-red-500">*</span></p>
                    <Controller
                        name="area_name"
                        control={control}
                        render={({ field }) => (
                            <InputText style={{border:errors.area_name ? "1px solid red":""}} {...field} className="w-full block" id="cityname" placeholder="Enter area name" />
                        )}
                    />
                </div>
                <div className="flex flex-column">
                    <p className="mb-2 font-semibold">City <span className="text-red-500">*</span></p>
                    <Controller
                        name="city_id"
                        control={control}
                        render={({ field }) => (
                ...
                <div className="flex flex-column">
                    <p className="mb-2 font-semibold">Minimum Free Delivery Order Amount <span className="text-red-500">*</span></p>
                    <Controller
                ...
                <div className="flex flex-column">
                    <p className="mb-2 font-semibold">Delivery Charges <span className="text-red-500">*</span></p>
                    <Controller
                ...
                <Button onClick={handleSubmit(submitHandler)} disabled={loading} label={loading ? "Loading..." : "Submit"} className="mt-4" />
            </Dialog>
        </Card>
    )
}