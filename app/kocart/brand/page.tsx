...
export default function Brand() {
  ...
  const items = [{ label: 'Brand' }, { label: 'Brand List' }];
    ...
    <div>
      ...
      <Card className="m-4">
        ...
        <DataTable
          ...
          totalRecords={
            data?.adminBrandList?.total ? data?.adminBrandList?.total : 0
          }
          onPage={values => setPageData(values)}
          value={
            data?.adminBrandList?.brands ? data?.adminBrandList?.brands : []
          }
          paginator
      ...
      >
        ...
        <Button
          ...
          label={brandLoading ? 'Loading...' : 'Submit'}
          className="my-3"
